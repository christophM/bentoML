...
Her beliefs that machine learning really is just finding the best model are getting cemented.
...
It is my belief that the trade-off between "chasing numbers" and doing non-measurable work (like doing research on a new product instead of selling more of the old) is heavily tipped towards chasing numbers in our society.
